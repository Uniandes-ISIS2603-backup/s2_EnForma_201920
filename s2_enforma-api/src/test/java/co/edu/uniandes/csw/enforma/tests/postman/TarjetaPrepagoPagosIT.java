...
import co.edu.uniandes.csw.enforma.resources.TarjetaPrepagoPagosResource;
...
public class TarjetaPrepagoPagosIT 
{
    private static final String COLLECTION = "TarjetaPrepagoPagosResourceTest.postman_collection";
    ...
    public static WebArchive createDeployment() {
        return ShrinkWrap.create(WebArchive.class, "s2_enforma-api.war")//War del modulo api
                ...
                .addPackage(TarjetaPrepagoPagosResource.class.getPackage()) //No importa cual recurso usar, lo importante es agregar el paquet
